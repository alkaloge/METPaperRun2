...
python Wjets.py -f /eos/uscms/store/group/lpcsusyhiggs/ntuples/nAODv9/2017/WJetsToLNu/all_WJetsToLNu_file058_part_1of3_Electrons.root --nickName WJetsToLNu -s WJetsToLNu -w 0 -y 2017 -j 1 -d MC -o WJetsToLNu_001.root -n 2000
