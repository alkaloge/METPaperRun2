...
class outTuple2Lep() :
	...
	self.u_perp_METCorGood_T1 = array('f',[-99])
	    ...
	    self.u_par_METCorGoodUnclusteredUp = array('f',[-99])
	    self.u_perp_METCorGoodUnclusteredUp = array('f',[-99])
	    self.u_par_PuppiMETCorGoodUnclusteredUp = array('f',[-99])
	    self.u_perp_PuppiMETCorGoodUnclusteredUp = array('f',[-99])

	    self.u_par_METCorGoodUnclusteredDown = array('f',[-99])
	    self.u_perp_METCorGoodUnclusteredDown = array('f',[-99])
	    self.u_par_PuppiMETCorGoodUnclusteredDown = array('f',[-99])
	    self.u_perp_PuppiMETCorGoodUnclusteredDown = array('f',[-99])

            #JES
	    self.u_par_METCorGoodJESUp = array('f',[-99])
	    self.u_perp_METCorGoodJESUp = array('f',[-99])
	    self.u_par_PuppiMETCorGoodJESUp = array('f',[-99])
	    self.u_perp_PuppiMETCorGoodJESUp = array('f',[-99])

	    self.u_par_METCorGoodJESDown = array('f',[-99])
	    self.u_perp_METCorGoodJESDown = array('f',[-99])
	    self.u_par_PuppiMETCorGoodJESDown = array('f',[-99])
	    self.u_perp_PuppiMETCorGoodJESDown = array('f',[-99])


	    #JER
	    self.u_par_METCorGoodJERUp = array('f',[-99])
	    self.u_perp_METCorGoodJERUp = array('f',[-99])
	    self.u_par_PuppiMETCorGoodJERUp = array('f',[-99])
	    self.u_perp_PuppiMETCorGoodJERUp = array('f',[-99])

	    self.u_par_METCorGoodJERDown = array('f',[-99])
	    self.u_perp_METCorGoodJERDown = array('f',[-99])
	    self.u_par_PuppiMETCorGoodJERDown = array('f',[-99])
	    self.u_perp_PuppiMETCorGoodJERDown = array('f',[-99])
	...
	self.t.Branch('Puppiboson_phi', self.Puppiboson_phi, 'Puppiboson_phi/F')
	    ...
	    self.t.Branch('Puppiboson_phiJERDown/F', self.Puppiboson_phiJERDown, 'Puppiboson_phiJERDown/F')
            ...
            #fix
	    self.t.Branch('u_par_METCorGoodUnclusteredUp', self.u_par_METCorGoodUnclusteredUp, 'u_par_METCorGoodUnclusteredUp/F')
	    self.t.Branch('u_perp_METCorGoodUnclusteredUp', self.u_perp_METCorGoodUnclusteredUp, 'u_perp_METCorGoodUnclusteredUp/F')
	    ...
	    self.t.Branch('u_par_METCorGoodUnclusteredDown', self.u_par_METCorGoodUnclusteredDown, 'u_par_METCorGoodUnclusteredDown/F')
	    self.t.Branch('u_perp_METCorGoodUnclusteredDown', self.u_perp_METCorGoodUnclusteredDown, 'u_perp_METCorGoodUnclusteredDown/F')
	    ...
	    self.t.Branch('u_par_METCorGoodJESUp', self.u_par_METCorGoodJESUp, 'u_par_METCorGoodJESUp/F')
	    self.t.Branch('u_perp_METCorGoodJESUp', self.u_perp_METCorGoodJESUp, 'u_perp_METCorGoodJESUp/F')
	    ...
	    self.t.Branch('u_par_METCorGoodJESDown', self.u_par_METCorGoodJESDown, 'u_par_METCorGoodJESDown/F')
	    self.t.Branch('u_perp_METCorGoodJESDown', self.u_perp_METCorGoodJESDown, 'u_perp_METCorGoodJESDown/F')
	    ...
	    self.t.Branch('u_par_METCorGoodJERUp', self.u_par_METCorGoodJERUp, 'u_par_METCorGoodJERUp/F')
	    self.t.Branch('u_perp_METCorGoodJERUp', self.u_perp_METCorGoodJERUp, 'u_perp_METCorGoodJERUp/F')
	    ...
	    self.t.Branch('u_par_METCorGoodJERDown', self.u_par_METCorGoodJERDown, 'u_par_METCorGoodJERDown/F')
	    self.t.Branch('u_perp_METCorGoodJERDown', self.u_perp_METCorGoodJERDown, 'u_perp_METCorGoodJERDown/F')
	...
	#metNoTauES holds the uncorrected TauES MET - if not doUncerta -> holds the default ucorrected MET, if doUncert the T1_corrected
		...
		if doUncertainties : 
			...
			self.u_perp_PuppiMETUnclusteredDown[0]= self.getu_perp_MET( entry, metV.X(), metV.Y(), (LepP+LepM).X(), (LepP+LepM).Y(), (LepP+LepM).Pt() )
                        ...
                        # if isMC if doUncertainties identation
