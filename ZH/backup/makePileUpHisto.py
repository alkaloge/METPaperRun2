...
hMC = TH1D("hPileup_nTrueInt","hPileup_nTrueInt",nBins,xMin,xMax)
hMC2 = TH1D("hPileup_nPU","hPileup_nPU",nBins,xMin,xMax)
hMC3 = TH1D("hPV_npvsGood","hPV_npvsGood",nBins,xMin,xMax)
hWeight = TH1D("hWeightPileup_nTrueIn","hWeightPileup_nTrueIn",nBins,xMin,xMax)
hWeight2 = TH1D("hWeightPileup_nPU","hWeightPileup_nPU",nBins,xMin,xMax)
hWeight3 = TH1D("hWeightPV_npvsGood","hWeightPV_npvsGood",nBins,xMin,xMax)
...
for i, e in enumerate(inTree) :
    if i >= nMax : break
    hMC.Fill(e.Pileup_nTrueInt)
    hMC2.Fill(e.Pileup_nPU)
    hMC3.Fill(e.PV_npvsGood)
    hWeight.Fill(e.Pileup_nTrueInt,e.genWeight)
    hWeight2.Fill(e.Pileup_nPU,e.genWeight)
    hWeight2.Fill(e.PV_npvsGood,e.genWeight)
