...
if inTree.GetEntries()>0 : 
	...
	for cat in catss: 
		...
		vetoMuons = tauFun.makevetoMuonList(e)
		...
		if len(vetoElectrons) > 0 : continue
		'''
		#if e.nElectron > 0:
