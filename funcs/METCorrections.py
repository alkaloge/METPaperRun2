...
def correctedMET(
        ...
        ispuppi=False):
    year = str(yeara)
    # print 'some info=================================', isMC, year, isUL,
    # ispuppi, runnb
    if(npv > 100):
        npv = 100
    runera = -1
    ...
    if (isMC and year == "2016" and isUL):
        runera = "yUL2016MCnonAPV"
    elif(isMC and year == "2016APV" and isUL):
        runera = "yUL2016MCAPV"
    elif(isMC and year == "2016nonAPV" and isUL):
        runera = "yUL2016MCnonAPV"
    elif(isMC and year == "2017" and isUL):
        runera = "yUL2017MC"
    elif(isMC and year == "2018" and isUL):
        runera = "yUL2018MC"

    elif(not isMC and runnb >= 315252 and runnb <= 316995 and isUL):
        runera = "yUL2018A"
    elif(not isMC and runnb >= 316998 and runnb <= 319312 and isUL):
        runera = "yUL2018B"
    elif(not isMC and runnb >= 319313 and runnb <= 320393 and isUL):
        runera = "yUL2018C"
    elif(not isMC and runnb >= 320394 and runnb <= 325273 and isUL):
        runera = "yUL2018D"
    ...
    elif(not isMC and runnb >= 272007 and runnb <= 275376 and isUL):
        runera = "yUL2016B"
    elif(not isMC and runnb >= 275657 and runnb <= 276283 and isUL):
        runera = "yUL2016C"
    elif(not isMC and runnb >= 276315 and runnb <= 276811 and isUL):
        runera = "yUL2016D"
    elif(not isMC and runnb >= 276831 and runnb <= 277420 and isUL):
        runera = "yUL2016E"

    elif(not isMC and ((runnb >= 277772 and runnb <= 278768) or runnb == 278770) and isUL):
        runera = "yUL2016F"
    elif(not isMC and ((runnb >= 278801 and runnb <= 278808) or runnb == 278769) and isUL):
        runera = "yUL2016Flate"
    elif(not isMC and runnb >= 278820 and runnb <= 280385 and isUL):
        runera = "yUL2016G"
    elif(not isMC and runnb >= 280919 and runnb <= 284044 and isUL):
        runera = "yUL2016H"
    ...
    if CorrectedMET_x == 0 and CorrectedMET_y > 0:
        CorrectedMETPhi = math.pi
    elif CorrectedMET_x == 0 and CorrectedMET_y < 0:
        CorrectedMETPhi = -math.pi
    elif CorrectedMET_x > 0:
        CorrectedMETPhi = math.atan(CorrectedMET_y / CorrectedMET_x)
    elif CorrectedMET_x < 0 and CorrectedMET_y > 0:
        CorrectedMETPhi = math.atan(CorrectedMET_y / CorrectedMET_x) + math.pi
    elif CorrectedMET_x < 0 and CorrectedMET_y < 0:
        CorrectedMETPhi = math.atan(CorrectedMET_y / CorrectedMET_x) - math.pi
    else:
        CorrectedMETPhi = 0.
