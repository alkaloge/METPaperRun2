...
#if '2016' in sys.argv[2]  : p=PostProcessor("./",fnames, "(HLT_IsoMu22 || HLT_IsoMu22_eta2p1 || HLT_IsoTkMu22 || HLT_IsoTkMu22_eta2p1) && Muon_pt > 24. && abs(Muon_eta) < 2.5 && abs(Muon_dxy) < 0.05 && abs(Muon_dz)<0.25 && Muon_mediumId>0 && Muon_pfRelIso04_all< 0.5 && Entry$ >= Entries$*STARTEVENT &&  Entry$ < Entries$*FINISHEVENT","",[ jmeCorrections()],provenance=True,  outputbranchsel="keep_and_drop.txt")
#IsoTkMu24
#if '2016' in sys.argv[2]  : p=PostProcessor("./",fnames, "(HLT_IsoMu24 || HLT_IsoTkMu24) && Muon_pt > 26. && abs(Muon_eta) < 2.5 && abs(Muon_dxy) < 0.05 && abs(Muon_dz)<0.25 && Muon_mediumId>0 && Muon_pfRelIso04_all< 0.5 && Entry$ >=0 &&  Entry$ < 1000","",[ jmeCorrections()],provenance=True,  outputbranchsel="keep_and_drop.txt")
if '2016' in sys.argv[2]  : p=PostProcessor("./",fnames, "(HLT_IsoMu24 || HLT_IsoTkMu24) && Muon_pt > 26. && abs(Muon_eta) < 2.5 && abs(Muon_dxy) < 0.05  Entry$ >=0 &&  Entry$ < 1000","",[ jmeCorrections()],provenance=True,  outputbranchsel="keep_and_drop.txt")

#else :p=PostProcessor("./",fnames, "(HLT_IsoMu27) && Muon_pt > 29. && abs(Muon_eta) < 2.5 && abs(Muon_dxy) < 0.05 && abs(Muon_dz)<0.25 && Muon_mediumId>0  && Muon_pfRelIso04_all< 0.5 && Entry$ >= Entries$*STARTEVENT &&  Entry$ < Entries$*FINISHEVENT","",[ jmeCorrections()],provenance=True,  outputbranchsel="keep_and_drop.txt")
else :p=PostProcessor("./",fnames, "(HLT_IsoMu27) && Muon_pt > 29. && abs(Muon_eta) < 2.5 && abs(Muon_dxy) < 0.05 && abs(Muon_dz)<0.25 && Muon_mediumId>0  && Muon_pfRelIso04_all< 0.5 && Entry$ >= 0 &&  Entry$ < 1000","",[ jmeCorrections()],provenance=True,  outputbranchsel="keep_and_drop.txt")
#else :p=PostProcessor("./",fnames, "(HLT_IsoMu24 || HLT_IsoMu27) && Muon_pt > 26. && abs(Muon_eta) < 2.5 && abs(Muon_dxy) < 0.05 && abs(Muon_dz)<0.25 && Muon_mediumId>0  && Muon_pfRelIso04_all< 0.5 && genWeight<15    && Entry$ >= Entries$*STARTEVENT &&  Entry$ < Entries$*FINISHEVENT","",[ jmeCorrections()],provenance=True,  outputbranchsel="keep_and_drop.txt")
