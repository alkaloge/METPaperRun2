...
#IsoTkMu24
if '2016' in sys.argv[2]  : p=PostProcessor("./",fnames, "(HLT_IsoMu24 || HLT_IsoTkMu24) && Muon_pt > 26. && abs(Muon_eta) < 2.5 && abs(Muon_dxy) < 0.05 && abs(Muon_dz)<0.25 && Muon_mediumId>0 && Muon_pfRelIso04_all< 0.5 && Entry$ >= Entries$*STARTEVENT &&  Entry$ < Entries$*FINISHEVENT","",[ jmeCorrections()],provenance=True,  outputbranchsel="keep_and_drop.txt")
