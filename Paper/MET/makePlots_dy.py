...
#vars = ["METCorGood_T1Smear_pt", "PuppiMETCorGood_pt"]
#vars = ["PuppiMETCorGood_pt"]
#vars = ['u_parboson_RawMET']


varsan = ["METCorGood_T1Smear_phi", "METCorGood_T1Smear_pt", "METCorGood_T1_phi", "METCorGood_T1_pt", "PuppiMETCorGood_phi", "PuppiMETCorGood_pt", "RawMET_phi", "RawMET_pt", "RawPuppiMET_phi", "RawPuppiMET_pt", "boson_pt", "mll", "u_parboson_METCorGood_T1", "u_parboson_METCorGood_T1Smear", "u_parboson_PuppiMETCorGood", "u_parboson_RawMET", "u_parboson_RawPuppiMET", "u_perp_METCorGood_T1", "u_perp_METCorGood_T1Smear", "u_perp_PuppiMETCorGood", "u_perp_RawMET", "u_perp_RawPuppiMET"]
...
if True:
    ...
    for nj in alljetcuts:
        ...
        njets = nj + '_nbtagl_' + ID + "_varbins_isocut" + pu
        njets = nj + '_nobtag_' + ID + "_varbins_isocut" + pu
        #njets = nj+'_nobtag_' + ID + "_varbins_isocut_metlt100"+pu
                ...
                for ch in channels:
                    for var in vars:
                        ...
                        if 'Smear' in var:
                            ...
                            cpSmeardata = "cp Jobs_dy_{5:s}{6:s}/plotS_{0:s}_data_{1:s}_hitslt{2:s}_{7:s}_{4:s}.root  Jobs_dy_{5:s}{6:s}/plotS_{0:s}_data_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root".format(
                        ...
                        patternNom = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root".format(
                        ...
                        patternJE = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}JE*_{4:s}.root".format(
                            yr, njets, veto, var, ch, ID, dirDY)
                        patternUncl = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}Uncl*_{4:s}.root".format(
                            yr, njets, veto, var, ch, ID, dirDY)
                        patternPU = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}PU*_{4:s}.root".format(
                            yr, njets, veto, var, ch, ID, dirDY)
                        patternID = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}ID*_{4:s}.root".format(
                            yr, njets, veto, var, ch, ID, dirDY)

                        patternNomSD = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root".format(
                            yr, njetssideband, veto, var, ch, ID, dirDY)
                        patternJESD = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}JE*_{4:s}.root".format(
                            yr, njetssideband, veto, var, ch, ID, dirDY)
                        patternUnclSD = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}Uncl*_{4:s}.root".format(
                            yr, njetssideband, veto, var, ch, ID, dirDY)
                        patternPUSD = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}PU*_{4:s}.root".format(
                            yr, njetssideband, veto, var, ch, ID, dirDY)
                        patternIDSD = " Jobs_dy_{5:s}{6:s}/plotS_{0:s}_*_{1:s}_hitslt{2:s}_{3:s}ID*_{4:s}.root".format(
                            yr, njetssideband, veto, var, ch, ID, dirDY)
                        ...
                        if yr == 'Run2':
                            hadd_command = "hadd -f {0:s} {5:s}/plotS_2016preVFP_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root {5:s}/plotS_2016postVFP_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root {5:s}/plotS_2017_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root {5:s}/plotS_2018_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root".format(fileIn,njets,veto,var,ch,rootDir)
                        if yr == '2016':
                        ...
                        if yr == '2016':
                            fileIn = "{5:s}/plotS_{0:s}_{1:s}_hitslt{2:s}_{3:s}_{4:s}.root".format(
                                yr, njets, veto, var, ch, rootDir)
                        os.system("python3 makeStack_dy.py -f {} -y {} -v {} -q 0 -e {} -c {} -l no".format(fileIn, yr, var, extraTag, ch))
                        # -c is the channel, use mumu or mm
                        ...
                        # cp
                        # plots/test/paperv2/${var}_${ch}${yr}_doQCD_0${extraTagNLO}_1Log.pdf
                        # /publicweb/a/alkaloge/plots/MetStudiesPaper/${var}_${yr}_doQCD0_${extraTagNLO}_Log_${ch}.pdf
