...
class SFs():  
    ...
    def get_EfficiencyMC(self,pt, eta) :
        ...
        #print "inside eff_mc pt",pt,"eta",eta,"label",label,"N",self.eff_mcH[label].GetN(),"ptbin",ptbin, eff
    ...
    def get_EfficiencyData(self,pt, eta) :
        ...
        #print "inside eff_data pt",pt,"eta",eta,"label",label,"N",self.eff_dataH[label].GetN(),"ptbin",ptbin, eff
