...
for key, value in data_dict.iteritems():
    ...
    filemc='/eos/uscms/store/group/lpcsusyhiggs/ntuples/nAODv9/2Lep/{0:s}_{1:s}/{0:s}_{1:s}_ElEl.root'.format(key, year)
    filemc='/eos/uscms/store/group/lpcsusyhiggs/ntuples/nAODv9/HZZ2L2Nu/{0:s}_{1:s}/{0:s}_{1:s}_ElEl.root'.format(key, year)
