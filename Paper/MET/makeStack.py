...
if __name__ == "__main__":
    ...
    #plotS_2018_data_njetsgeq0_hitslt2_METWmass_MuNu.root
    isLog = 1
    ...
    for ilog in logcase :
        isLog = ilog
	plot_var = Canvas.Canvas("test/paperv2/%s_%s%s%s%s_doQCD_%s%s_%sLog"%(str(opts.varr),puname, channel, puname ,str(era), str(int(doQCD)), innOr, str(isLog)), "png,root,pdf,C", leg[0], leg[1], leg[2], leg[3])               
