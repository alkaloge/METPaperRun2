...
void graph_scale_npv(const std::string& vs="_vspt_", const std::string& year="2018", const std::string& channelDir="Gjets_mc_sub", const std::string& channel="MuMu", const std::string& mc_="dy", const std::string& njet_="eq0"){
  //setTDRStyle();
  ...
  cout <<"working on npv ..." <<"txt_"+channelDir+"/puppi_" + year + common_part + channel + ".txt"<<endl;
...
//std::vector<Double_t> bins;
 ...
 Float_t bins[8]; // Maximum size of the array
