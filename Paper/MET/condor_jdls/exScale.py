...
for year in years:
    for channel in channels:
        ...
        if 'Gjets' in channel : modes =["Gjets"]
        ...
        print "cp scale_{0}*_*_{1}_{2}.pdf res_p*_{0}*_njets*_*_{1}_{2}.pdf plots_*_{0}_{1}_{2}.pdf /publicweb/a/alkaloge/plots/MetStudiesPaper/Scales/".format(year, channelDir, extra)
        os.system("cp scale_{0}*_*_{1}_{2}.pdf res_p*_{0}*_njets*_*_{1}_{2}.pdf plots_*_{0}_{1}_{2}.pdf /publicweb/a/alkaloge/plots/MetStudiesPaper/Scales/".format(year, channelDir, extra))
