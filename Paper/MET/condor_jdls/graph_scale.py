...
def graph_scale(year):
    ...
    #puppi_2018_alldata_vspt_njetsgeq0_njetsgeq0_ElEl.txt
    f1 = open("rawmet_{}_dy_vspt_njetsgeq0_{}.txt".format(year,channel), "r")
    f2 = open("t1_{}_dy_vspt_njetsgeq0_{}.txt".format(year,channel), "r")
    f2s = open("t1smear_{}_dy_vspt_njetsgeq0_{}.txt".format(year,channel), "r")
    f3 = open("puppi_{}_dy_vspt_njetsgeq0_{}.txt".format(year,channel), "r")



    f1d = open("rawmet_{}_alldata_vspt_njetsgeq0_{}.txt".format(year,channel), "r")
    f2d = open("t1_{}_alldata_vspt_njetsgeq0_{}.txt".format(year,channel), "r")
    f3d = open("puppi_{}_alldata_vspt_njetsgeq0_{}.txt".format(year,channel), "r")
