...
for i, cut in enumerate(cuts_vspt):
	...
	outrawmetd.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(cut, h_scale_rawmet.GetMean(), h_scale_rawmet.GetMeanError(), scalecor_rawmet*h_upara_rawmet.GetRMS(), scalecor_rawmet*h_upara_rawmet.GetRMSError(), scalecor_rawmet*h_uperp_rawmet.GetRMS(), scalecor_rawmet*h_uperp_rawmet.GetRMSError()))

	outrawpuppid.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(cut, h_scale_rawpuppi.GetMean(), h_scale_rawpuppi.GetMeanError(), scalecor_rawpuppi*h_upara_rawpuppi.GetRMS(), scalecor_rawpuppi*h_upara_rawpuppi.GetRMSError(), scalecor_rawpuppi*h_uperp_rawpuppi.GetRMS(), scalecor_rawpuppi*h_uperp_rawpuppi.GetRMSError()))

	outt1d.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(cut, h_scale_t1.GetMean(), h_scale_t1.GetMeanError(), scalecor_t1*h_upara_t1.GetRMS(), scalecor_t1*h_upara_t1.GetRMSError(), scalecor_t1*h_uperp_t1.GetRMS(), scalecor_t1*h_uperp_t1.GetRMSError()))
	if isMC : outt1smeard.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(cut, h_scale_t1smear.GetMean(), h_scale_t1smear.GetMeanError(), scalecor_t1smear*h_upara_t1smear.GetRMS(), scalecor_t1smear*h_upara_t1smear.GetRMSError(), scalecor_t1smear*h_uperp_t1smear.GetRMS(), scalecor_t1smear*h_uperp_t1smear.GetRMSError()))

	outpuppid.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(cut, h_scale_puppi.GetMean(), h_scale_puppi.GetMeanError(), scalecor_puppi*h_upara_puppi.GetRMS(), scalecor_puppi*h_upara_puppi.GetRMSError(), scalecor_puppi*h_uperp_puppi.GetRMS(), scalecor_puppi*h_uperp_puppi.GetRMSError()))
...
print h_scale_puppi_npv.GetBinContent(1)
