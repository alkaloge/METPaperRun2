...
if command.lower() == "extract" or command.lower() == 'step3': 
	...
	for channel in channels:
		...
		if channel != "Gjets" : 
		    ...
		    if channel == "ElEl" : 
			if year == "2017" or '2016' in year :os.system("python extract2.py scales_SingleElectron_Run{0}_{1}_Njet{2}.root {0} {1} {1:s}".format(year, channel, njet))
			if year == "2018" :os.system("python extract2.py scales_EGamma_Run{0}_{1}_Njet{2}.root {0} {1} {1:s}".format(year, channel, njet))
